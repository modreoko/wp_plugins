...
class XLSXWriter
{
	...
	public function tempFilename( $prefix = "xlsx_writer_" )
	{
		$tempdir = !empty($this->tempdir) ? $this->tempdir : sys_get_temp_dir();
		$filename = tempnam($tempdir, $prefix );
		if (!$filename) {
	...
	public function writeToStdOut( $file_name = null )
	{
	    if( $file_name === null ){
	        $file_name = $this->tempFilename();
	    }
